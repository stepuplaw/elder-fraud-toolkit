 ...
 */
import { type FraudPreventionContact } from './contacts.js';
...
export declare function qrCodeSvg(text: string, options?: QrCodeOptions): string;
/**
 ...
 */
export declare function qrCodeForContact(contact: FraudPreventionContact, options?: QrCodeOptions): string;
